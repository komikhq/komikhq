/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d2f8eb9bc6f966a2130968f1c4baeaaa)
// Runtime types generated with workerd@1.20260903.1 2026-08-31 global_fetch_strictly_public
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	PUBLIC_API_URL: string;
	PUBLIC_USERS_CDN_URL: string;
	PUBLIC_MEDIA_CDN_URL: string;
	PUBLIC_PUSHER_KEY: string;
	PUBLIC_PUSHER_CLUSTER: string;
	BETTER_AUTH_URL: string;
	BETTER_AUTH_SECRET: string;
	BACKEND: Fetcher /* komikhq-api */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_API_URL" | "PUBLIC_USERS_CDN_URL" | "PUBLIC_MEDIA_CDN_URL" | "PUBLIC_PUSHER_KEY" | "PUBLIC_PUSHER_CLUSTER" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET">> {}
}
